...
gnome-terminal -- bash -c 'ssh -i /home/patrick/Desktop/holding/caltech/MockImagePipeline.pem ubuntu@$EC2_IP -t "cd ~/cloud-mock-image-pipeline; ./set_up_kafka_client.sh image_event_alert_client.py"'

# Run the image analysis Kafka python client on Amazon Cloud
gnome-terminal -- bash -c 'ssh -i /home/patrick/Desktop/holding/caltech/MockImagePipeline.pem ubuntu@$EC2_IP -t "cd ~/cloud-mock-image-pipeline; ./set_up_kafka_client.sh image_analysis_client.py"'
