...
def store_image_metadata(image_filename, image_recv_path, image_storage_key):
    """
    ...
    try:
        ...
        print(f"Adding image filename {image_filename} and its image storage key {image_storage_key} to the image metadata database table")
...
def receive_image(image_num, image_filename, image_recv_path, prev_image_recv_path):
    ...
    image_storage_key = store_image(image_filename, image_recv_path)

    # store image metadata in relational database;
    # returned new image_id will be passed to the Kafka image analysis client
    image_id = store_image_metadata(image_filename, image_recv_path, image_storage_key)
